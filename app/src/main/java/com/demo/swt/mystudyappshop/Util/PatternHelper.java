...
public class PatternHelper {
    ...
    public void saveToStorage(String gesturePwd) {
        ...
        SharedPreferencesUtils.getInstance().saveString(GESTURE_PWD_KEY, encryptPwd);
    }

    public String getFromStorage() {
        final String result = SharedPreferencesUtils.getInstance().getString(GESTURE_PWD_KEY);
