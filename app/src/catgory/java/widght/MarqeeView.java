 ...
 * 时间: 24/4/18
 */
public class MarqeeView extends View implements Runnable {
    ...
    public MarqeeView(Context context) {
        this(context, null);
    }

    public MarqeeView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MarqeeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
