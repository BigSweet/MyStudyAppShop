        ...
        if (mLeft == -1) {
            holder.recommend.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                ...
                public boolean onPreDraw() {
                    ...
                    mLeft = (int) (holder.recommend.getLeft() + layout.getPrimaryHorizontal(0)) - TouchHelpActivity.dip2px(mContext, 10);   //textView左边距离+第一个文字绘制的距离 设置了padding 所以要减掉
        ...
        holder.city.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isRecommend) {
                    ...
                    if (mRight == -1) {
                        mRight = mLeft + holder.city.getLeft() - TouchHelpActivity.dip2px(mContext, 10);
                    }
